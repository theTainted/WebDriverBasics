 ...
 */
public class TwotoFiveMillionContactFormSegmentMerchantServiceProvidersIndependentTelcoResellers {
    String sURL = ContactForm.sURL;

  //  public static void main(String[] args) {
    @Test
       public void testTwotoFiveMillionContactFormSegmentMerchantServiceProvidersIndependentTelcoResellers(){
    System.setProperty("webdriver.chrome.driver", "C:/chromedriver.exe");
        ...
        contactform.countrySelector("Peru");
