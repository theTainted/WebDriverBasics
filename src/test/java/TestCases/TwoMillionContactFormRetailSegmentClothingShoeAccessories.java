 ...
 */
public class TwoMillionContactFormRetailSegmentClothingShoeAccessories {
 // private static String sURL = "https://www-ingenico-test-global.lostboys.nl/br/epayments/contato";
  ...
  //  public static void main(String[] args) {
    @Test
       public void testTwoMillionContactFormRetailSegmentClothingShoeAccessories(){
    ...
    System.setProperty("webdriver.chrome.driver", "C:/chromedriver.exe");
       ...
       // driver.navigate().to(sURL);
        ...
        contactform.countrySelector("Canada");
