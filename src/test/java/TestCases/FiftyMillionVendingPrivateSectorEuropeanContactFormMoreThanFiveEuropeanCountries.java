 ...
 */
public class FiftyMillionVendingPrivateSectorEuropeanContactFormMoreThanFiveEuropeanCountries {

    String sURL = ContactForm.sURL;

    //  public static void main(String[] args) {
    @Test
    public void testFiftyMillionVendingPrivateSectorEuropeanContactFormMoreThanFiveEuropeanCountries(){
        ...
        contactform.selectSegmentForVending("Private operators");
