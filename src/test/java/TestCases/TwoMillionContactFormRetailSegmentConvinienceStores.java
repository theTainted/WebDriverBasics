 ...
 */
public class TwoMillionContactFormRetailSegmentConvinienceStores {
 // private static String sURL = "https://www-ingenico-test-global.lostboys.nl/br/epayments/contato";
  ...
  //  public static void main(String[] args) {
    @Test
       public void testTwoMillionContactFormRetailSegmentConvinienceStores(){
    ...
    System.setProperty("webdriver.chrome.driver", "C:/chromedriver.exe");
       ...
       // driver.navigate().to(sURL);
        ...
        contactform.countrySelector("Austria");
